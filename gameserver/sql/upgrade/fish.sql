...
CREATE TABLE `fish` (
	...
	`fish_type` int(1) NOT NULL default '0', -- 0 = wide, 1 = swift, 2 = ugly, 3 = box, 4 = easy_wide, 5 = easy_swift, 6 = easy_ugly, 7 = hard_wide, 8 = hard_swift, 9 = hard_ugly, 10 = hot springs
...
(8547,20,'Old Box',1185,40,10,1,618,3000,20000,30000),
(8547,21,'Old Box',1230,46,10,1,624,3000,20000,27000),
(8547,22,'Old Box',1488,55,10,1,630,2000,20000,27000),
(8547,23,'Old Box',1540,57,10,1,630,2000,20000,27000),
(8547,24,'Old Box',1593,59,10,1,642,2000,20000,27000),
(8547,25,'Old Box',1645,59,10,1,648,2000,20000,28000),
(8547,26,'Old Box',1892,76,10,1,654,2000,20000,25000),
(8547,27,'Old Box',1950,78,10,1,658,2000,20000,25000);