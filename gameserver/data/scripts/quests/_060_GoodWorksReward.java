...
public class _060_GoodWorksReward extends Quest
{
	...
	private static HardReference<NpcInstance> Last_Spawned_Pursuer = HardReferences.emptyRef();
	...
	{
		return Last_Spawned_Pursuer.get() != null;
	}
	...
	{
		Last_Spawned_Pursuer = HardReferences.emptyRef();
	...
	static
	{
		profs.put(1, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-WL\">Warlord.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-GL\">Gladiator.</a>");
		profs.put(4, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-PA\">Paladin.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-DA\">Dark Avenger.</a>");
		profs.put(7, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-TH\">Treasure Hunter.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-HK\">Hawkeye.</a>");
		profs.put(11, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-SC\">Sorcerer.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-NM\">Necromancer.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-WA\">Warlock.</a>");
		profs.put(15, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-BS\">Bishop.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-PP\">Prophet.</a>");
		profs.put(19, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-TK\">Temple Knight.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-SS\">Swordsinger.</a>");
		profs.put(22, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-PW\">Plainswalker.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-SR\">Silver Ranger.</a>");
		profs.put(26, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-SP\">Spellsinger.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-ES\">Elemental Summoner.</a>");
		profs.put(29, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-EE\">Elven Elder.</a>");
		profs.put(32, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-SK\">Shillien Knight.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-BD\">Blade Dancer.</a>");
		profs.put(35, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-AW\">Abyss Walker.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-PR\">Phantom Ranger.</a>");
		profs.put(39, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-SH\">Spellhowler.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-PS\">Phantom Summoner.</a>");
		profs.put(42, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-SE\">Shillien Elder.</a>");
		profs.put(45, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-DT\">Destroyer.</a>");
		profs.put(47, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-TR\">Tyrant.</a>");
		profs.put(50, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-OL\">Overlord.</a><br><a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-WC\">Warcryer.</a>");
		profs.put(54, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-BH\">Bounty Hunter.</a>");
		profs.put(56, "<a action=\"bypass -h npc_%objectId%_QuestEvent _060_GoodWorksReward marks-WS\">Warsmith.</a>");
