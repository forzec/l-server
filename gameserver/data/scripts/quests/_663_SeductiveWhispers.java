...
public class _663_SeductiveWhispers extends Quest
{
	...
	static
	{
		...
		Dialog_WinLevel += "<a action=\"bypass -h npc_%objectId%_QuestEvent _663_SeductiveWhispers 30846_12.htm\">Pull next card!</a><br>";
		Dialog_WinLevel += "<a action=\"bypass -h npc_%objectId%_QuestEvent _663_SeductiveWhispers 30846_13.htm\">\"No, enough for me, end game and take my prize.\"</a>";
		...
		Dialog_WinGame += "<a action=\"bypass -h npc_%objectId%_QuestEvent _663_SeductiveWhispers 30846_03.htm\">Return</a>";
		...
		Dialog_Rewards += "<a action=\"bypass -h npc_%objectId%_QuestEvent _663_SeductiveWhispers 30846_03.htm\">Return</a>";
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("30846_12.htm") && _state == STARTED)
		{
			...
			dialog = dialog.replace("%level%", String.valueOf(next_round));
			dialog = dialog.replace("%prize%", current_reward.toString());
	...
	private static class LevelRewards
	{
		...
		public LevelRewards add(int[] items_id, int count)
		{
			...
			txt = txt.replace("%n%", String.valueOf(cnt));
