...
import org.mmocore.gameserver.network.l2.s2c.TutorialCloseHtml;
...
public class _255_Tutorial extends Quest
{
	...
	public class OnPlayerEnterListenerImpl implements OnPlayerEnterListener
	{
		@Override
	...
	public class TutorialShowListener implements OnCurrentHpDamageListener
	{
		...
		public void onCurrentHpDamage(Creature actor, double damage, Creature attacker, SkillEntry skill, boolean crit)
		{
			...
			if(player.getCurrentHpPercents() < 25)
			{
				...
				player.processQuestEvent(255, "CE45", null);
			}
