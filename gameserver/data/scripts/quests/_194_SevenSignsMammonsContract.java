...
public class _194_SevenSignsMammonsContract extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("colin_q194_3a.htm"))
		{
			...
			SkillTable.getInstance().getSkillEntry(6201, 1).getEffects(npc, player, false, false);
		}
		...
		else if(event.equalsIgnoreCase("colin_q194_6.htm"))
		{
			...
			st.playSound(SOUND_MIDDLE);
			negateSpeedBuffs(player);
			SkillTable.getInstance().getSkillEntry(6202, 1).getEffects(player, player, false, false);
		}
		...
		else if(event.equalsIgnoreCase("colin_q194_9.htm"))
		{
			...
			st.playSound(SOUND_MIDDLE);
			negateSpeedBuffs(player);
			SkillTable.getInstance().getSkillEntry(6203, 1).getEffects(player, player, false, false);
		}
		...
		else if(event.equalsIgnoreCase("colin_q194_11a.htm"))
		{
			...
			negateSpeedBuffs(player);
			SkillTable.getInstance().getSkillEntry(6201, 1).getEffects(player, player, false, false);
		}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		{
			QuestState qs = player.getQuestState(193);
