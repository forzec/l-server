...
public class _10275_ContainingTheAttributePower extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.setCond(5);
			SkillTable.getInstance().getSkillEntry(2635, 1).getEffects(player, player, false, false);
			st.giveItems(YinSword, 1, Element.FIRE, 10);
			st.playSound(SOUND_MIDDLE);
		}
		...
		{
			st.setCond(10);
			SkillTable.getInstance().getSkillEntry(2636, 1).getEffects(player, player, false, false);
			st.giveItems(YangSword, 1, Element.EARTH, 10);
			st.playSound(SOUND_MIDDLE);
		}
		else
