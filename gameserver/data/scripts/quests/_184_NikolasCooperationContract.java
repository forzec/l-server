...
public class _184_NikolasCooperationContract extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("32366-02.htm"))
		{
			...
			ChatUtils.shout(alarm, NpcString.INTRUDER_ALERT_THE_ALARM_WILL_SELFDESTRUCT_IN_2_MINUTES);
		}
		...
		{
			ChatUtils.shout(npc, NpcString.THE_ALARM_WILL_SELFDESTRUCT_IN_60_SECONDS);
			st.startQuestTimer("2", 30000, npc);
			return null;
		}
		else if(event.equalsIgnoreCase("2"))
		{
			ChatUtils.shout(npc, NpcString.THE_ALARM_WILL_SELFDESTRUCT_IN_30_SECONDS);
			st.startQuestTimer("3", 20000, npc);
			return null;
		}
		else if(event.equalsIgnoreCase("3"))
		{
			ChatUtils.shout(npc, NpcString.THE_ALARM_WILL_SELFDESTRUCT_IN_10_SECONDS);
