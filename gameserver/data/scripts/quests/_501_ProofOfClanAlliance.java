...
public class _501_ProofOfClanAlliance extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("30757-04.htm"))
		{
			...
			if(Rnd.chance(50))
				st.getPlayer().reduceCurrentHp(st.getPlayer().getCurrentHp() * 8, st.getPlayer(), null, 0, false, true, true, false, false, false, false, false);
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		for(int i : CHESTS)
			if(npcId == i)
			{
				...
				if(Rnd.chance(25))
				{
					ChatUtils.say(npc, NpcString.BINGO);
