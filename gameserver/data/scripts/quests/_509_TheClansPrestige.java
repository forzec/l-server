		...
		else
		{
			...
			else if(id == STARTED && cond == 1)
			{
				...
				else if(count == 1)
				{
					...
					st.getPlayer().sendPacket(new SystemMessage(SystemMsg.YOU_HAVE_SUCCESSFULLY_COMPLETED_A_CLAN_QUEST_S1_POINTS_HAVE_BEEN_ADDED_TO_YOUR_CLANS_REPUTATION_SCORE).addNumber(increasedPoints));
					st.takeItems(item, 1);
				}
			}
		}
