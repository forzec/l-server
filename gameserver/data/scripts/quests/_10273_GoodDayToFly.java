...
public class _10273_GoodDayToFly extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("32557-09.htm"))
		{
			...
			st.set("transform", "1");
			SkillTable.getInstance().getSkillEntry(5982, 1).getEffects(player, player, false, false);
		}
		else if(event.equalsIgnoreCase("32557-10.htm"))
		{
			...
			SkillTable.getInstance().getSkillEntry(5983, 1).getEffects(player, player, false, false);
		}
