...
public class NaiaRoomController extends DefaultAI
{
	...
	public boolean thinkActive()
	{
		...
		if(NaiaTowerManager.getInstance().isLockedRoom(npcId))
		{
			List<NpcInstance> _roomMobs = NaiaTowerManager.getInstance().getRoomMobs(npcId);
			...
			switch(npcId)
			{
				...
				case 18494:
				{
					...
					NaiaTowerManager.getInstance().unlockRoom(npcId);
					NaiaTowerManager.getInstance().removeRoomMobs(npcId);
					break;
				}
					//Room 2
				case 18495:
