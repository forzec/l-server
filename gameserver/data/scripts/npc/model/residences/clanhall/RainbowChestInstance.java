...
public class RainbowChestInstance extends MonsterInstance
{
	...
	public void reduceCurrentHp(double damage, Creature attacker, SkillEntry skill, int poleHitCount, boolean crit, boolean awake, boolean standUp, boolean directHp, boolean canReflect, boolean transferDamage, boolean isDot, boolean sendMessage)
	{
		...
		super.reduceCurrentHp(getMaxHp() * 0.2, attacker, skill, poleHitCount, crit, awake, standUp, directHp, canReflect, transferDamage, isDot, sendMessage);
	}
	...
	public void onDeath(Creature k)
	{
		...
		for(int i = 0; i < count; i++)
		{
			...
			if(chance <= 5)
			{
				dropItem(killer, ItemA, 1, false);
			}
			else if(chance > 5 && chance <= 10)
			{
				dropItem(killer, ItemB, 1, false);
			}
			else if(chance > 10 && chance <= 15)
			{
				dropItem(killer, ItemC, 1, false);
			}
			else if(chance > 15 && chance <= 20)
			{
				dropItem(killer, ItemD, 1, false);
			}
			else if(chance > 20 && chance <= 25)
			{
				dropItem(killer, ItemE, 1, false);
			}
			else if(chance > 25 && chance <= 30)
			{
				dropItem(killer, ItemF, 1, false);
			}
			else if(chance > 30 && chance <= 35)
			{
				dropItem(killer, ItemG, 1, false);
			}
			else if(chance > 35 && chance <= 40)
			{
				dropItem(killer, ItemH, 1, false);
			}
			else if(chance > 40 && chance <= 45)
			{
				dropItem(killer, ItemI, 1, false);
			}
			else if(chance > 45 && chance <= 50)
			{
				dropItem(killer, ItemK, 1, false);
			}
			else if(chance > 50 && chance <= 55)
			{
				dropItem(killer, ItemL, 1, false);
			}
			else if(chance > 55 && chance <= 60)
			{
				dropItem(killer, ItemN, 1, false);
			}
			else if(chance > 60 && chance <= 65)
			{
				dropItem(killer, ItemO, 1, false);
			}
			else if(chance > 65 && chance <= 70)
			{
				dropItem(killer, ItemP, 1, false);
			}
			else if(chance > 70 && chance <= 75)
			{
				dropItem(killer, ItemR, 1, false);
			}
			else if(chance > 75 && chance <= 80)
			{
				dropItem(killer, ItemS, 1, false);
			}
			else if(chance > 80 && chance <= 85)
			{
				dropItem(killer, ItemT, 1, false);
			}
			else if(chance > 85 && chance <= 90)
			{
				dropItem(killer, ItemU, 1, false);
			}
			else if(chance > 90 && chance <= 95)
			{
				dropItem(killer, ItemW, 1, false);
			}
			else if(chance > 95)
			{
				dropItem(killer, ItemY, 1, false);
			}
		}
	}
}
