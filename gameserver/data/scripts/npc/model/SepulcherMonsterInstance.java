...
public class SepulcherMonsterInstance extends MonsterInstance
{
	...
	private class VictimShout extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			broadcastPacket(new NpcSay(SepulcherMonsterInstance.this, ChatType.NPC_ALL, "forgive me!!"));
		}
	}
	...
	private class VictimSpawnKeyBox extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			broadcastPacket(new NpcSay(SepulcherMonsterInstance.this, ChatType.NPC_ALL, "Many thanks for rescue me."));
			if(_victimShout != null)
			{
				_victimShout.cancel(false);
				_victimShout = null;
