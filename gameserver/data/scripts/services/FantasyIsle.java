...
public class FantasyIsle implements OnInitScriptListener
{
	...
	private static void startQuestTimer(final String event, int time, final NpcInstance temp_npc)
	{
	...
	public static void start(NpcInstance temp_npc, String event)
	{
		...
		{
			Functions.npcSay(temp_npc, NpcString.WE_LOVE_YOU);
