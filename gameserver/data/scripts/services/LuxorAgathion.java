...
public class LuxorAgathion
{
	...
	{
			{ 6471, 25 }, // 25 Big Red Nimble Fish
	...
	public void angelAgathion(Player player, NpcInstance npc, String[] arg)
	{
		agathion(player, npc, ANGEL_BRACELET_IDS, 1);
	}

	@Bypass("services.LuxorAgathion:devilAgathion")
	public void devilAgathion(Player player, NpcInstance npc, String[] arg)
	{
		agathion(player, npc, DEVIL_BRACELET_IDS, 2);
	}

	private void agathion(Player player, NpcInstance npc, int braceletes[], int type)
	{
