...
public class HeartInfinityAttack extends Reflection
{
	...
	private void conquestBegins()
	{
		...
		if(invoker != null)
		{
			...
			ChatUtils.shout(ekimus, NpcString.I_SHALL_ACCEPT_YOUR_CHALLENGE_S1_COME_AND_DIE_IN_THE_ARMS_OF_IMMORTALITY, invoker.getName());
		}
		invokeDeathListener();
	...
	private class DeathListener implements OnDeathListener
	{
		...
		public void onDeath(Creature self, Creature killer)
		{
			...
			{
				((NpcInstance) self).dropItem(killer.getPlayer(), 13797, Rnd.get(2, 5), false);
	...
	private void handleEkimusStats()
	{
		...
		ekimus.removeStatsByOwner(this);
