	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		if("bbsgetfav".equals(cmd))
		{
			...
			try
			{
				...
				String tpl = HtmCache.getInstance().getHtml("scripts/services/community/bbs_favoritetpl.htm", player);
				while(rset.next())
				{
			...
			String html = HtmCache.getInstance().getHtml("scripts/services/community/bbs_getfavorite.htm", player);
