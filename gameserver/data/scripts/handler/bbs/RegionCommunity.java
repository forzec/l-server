...
public class RegionCommunity extends ScriptBbsHandler
{
	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		if("bbsloc".equals(cmd))
		{
			...
			HashMap<Integer, String> tpls = Util.parseTemplate(HtmCache.getInstance().getHtml("scripts/services/community/bbs_region_list.htm", player));
		...
		else if("bbsreglist".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getHtml("scripts/services/community/bbs_region_sellers.htm", player);
			...
			String tpl = HtmCache.getInstance().getHtml("scripts/services/community/bbs_region_stpl.htm", player);
		...
		else if("bbsregview".equals(cmd))
		{
			...
			String title = "-";
			String tpl = HtmCache.getInstance().getHtml("scripts/services/community/bbs_region_storetpl.htm", player);
			...
			String html = HtmCache.getInstance().getHtml("scripts/services/community/bbs_region_view.htm", player);
